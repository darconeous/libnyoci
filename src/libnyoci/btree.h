...
NYOCI_INTERNAL_EXTERN int bt_insert(
...
NYOCI_INTERNAL_EXTERN void* bt_find(
	void*const*			bt,
	const void*			item,
...
NYOCI_INTERNAL_EXTERN bool bt_remove(
	void**				bt,
	void*				item,
	bt_compare_func_t	compare_func,
...
NYOCI_INTERNAL_EXTERN void* bt_first(void* item);

//!	Finds the right-most node in the subtree described by item.
NYOCI_INTERNAL_EXTERN void* bt_last(void* item);
...
NYOCI_INTERNAL_EXTERN void* bt_next(void* item);
...
NYOCI_INTERNAL_EXTERN void* bt_prev(void* item);

//!	Traverses the given tree to determine the number of nodes it contains.
NYOCI_INTERNAL_EXTERN int bt_count(void*const* bt);

NYOCI_INTERNAL_EXTERN int bt_get_balance(void* node);

NYOCI_INTERNAL_EXTERN void bt_rotate_left(void** pivot);

NYOCI_INTERNAL_EXTERN void bt_rotate_right(void** pivot);

//!	Completely rebalance of the tree.
NYOCI_INTERNAL_EXTERN unsigned int bt_rebalance(void** bt);

//!	Completely unbalances the tree. Primarily useful for debugging.
NYOCI_INTERNAL_EXTERN unsigned int bt_unbalance(void** bt);

//!	Splays the tree to a new root. Useful for splay trees.
NYOCI_INTERNAL_EXTERN unsigned int bt_splay(void** bt, void* root);
